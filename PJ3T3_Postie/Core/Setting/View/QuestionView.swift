...
struct QuestionView: View {
    ...
    var body: some View {
        let questions = [
            ...
            Question(title: "실수로 편지를 삭제했어요. 복구 가능 한가요?", content: "매우 안타깝지만, 아직까지는 삭제된 편지를 복구하는 기능은 없어요...ㅠㅠ\n또한, 회원 탈퇴시에도 저장된 편지가 전부 삭제되고 복구가 불가능하니 편지 삭제와 회원탈퇴 할때는 신중히 생각해보시고 결정하시길 바랍니다!"),
            Question(title: "AI 완성이 무엇인가요?", content: "한줄 요약에서 'AI 완성' 기능은 '네이버 클라우드 플랫폼'에서 제공하는 'CLOVA Summary AI'기능을 뜻합니다.\n네이버에서 수년간 연구하여 개발한 수준 높은 자연어 처리 기술을 사용하고, 그래프 기반 랭킹 알고리즘을 적용하여 문서에서 가려낸 주요 내용을 기반으로 전체 내용을 간결하게 요약하는 기능입니다.\n\n자세한 사항은 인터넷 사이트 네이버 클라우드 플랫폼 > 서비스 > AI Service > CLOVA Summary에서 확인하실 수 있습니다!"),
